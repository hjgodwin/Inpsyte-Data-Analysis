...
function run_selected(table_type, run_type){
  ...
  $("#runner_popup").html("Inpsyte Data Analysis is processing your request. This may take some time.<br> <img id='loading' src='css/3dmoonanimation.gif' width=50 height=50>");
